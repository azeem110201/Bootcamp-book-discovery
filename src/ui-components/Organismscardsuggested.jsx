...
export default function Organismscardsuggested(props) {
  ...
  return (
    <View
      ...
      height="134px"
      position="relative"
      boxShadow="0px 0px 4px rgba(0.6899999976158142, 0.6899999976158142, 0.6899999976158142, 0.20000000298023224)"
      borderRadius="8px"
      padding="0px 0px 0px 0px"
      backgroundColor="rgba(255,255,255,1)"
      {...rest}
      {...getOverrideProps(overrides, "Organismscardsuggested")}
    >
      <View
        padding="0px 0px 0px 0px"
        width="91px"
