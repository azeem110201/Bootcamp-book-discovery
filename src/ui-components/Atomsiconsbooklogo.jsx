...
export default function Atomsiconsbooklogo(props) {
  ...
  return (
    <View
      ...
      {...rest}
      {...getOverrideProps(overrides, "Atomsiconsbooklogo")}
    >
      <View
        padding="0px 0px 0px 0px"
        position="absolute"
        ...
        left="0%"
        right="0%"
        {...getOverrideProps(overrides, "Group7764028")}
      >
        <Icon
          width="24px"
          height="24px"
          ...
          left="0%"
          right="0%"
          {...getOverrideProps(overrides, "Vector7764029")}
        ></Icon>
      </View>
      <View
        padding="0px 0px 0px 0px"
        ...
        left="4.17%"
        right="-4.17%"
        {...getOverrideProps(overrides, "Group7764030")}
      >
        <Icon
          width="24px"
          height="20.50323486328125px"
          viewBox={{ minX: 0, minY: 0, width: 24, height: 20.50323486328125 }}
          paths={[
            {
          ...
          left="0%"
          right="0%"
          {...getOverrideProps(overrides, "Vector7764031")}
        ></Icon>
      </View>
    </View>
  );
