...
import Moleculessearch from "./Moleculessearch";
import Atomsiconsclose from "./Atomsiconsclose";
export default function Organismsheaderfocused(props) {
  ...
  return (
    <View
      ...
      {...rest}
      {...getOverrideProps(overrides, "Organismsheaderfocused")}
    >
      <View
        padding="0px 0px 0px 0px"
        width="1165px"
        ...
        top="14px"
        left="100px"
        {...getOverrideProps(overrides, "Group 3771")}
      >
        <Atomslogo
          display="flex"
          gap="10px"
        ...
        >
          ...
          >
            ...
            <Moleculesbuttonprimarymoleculesheadernavwoiconmoleculesheadernavwicon
              ...
              {...getOverrideProps(
                overrides,
                "molecules/button/primary/molecules/headernav/wo icon/molecules/headernav/w icon7163248"
              )}
            ></Moleculesbuttonprimarymoleculesheadernavwoiconmoleculesheadernavwicon>
            <Moleculesbuttonprimarymoleculesheadernavwoiconmoleculesheadernavwicon
              display="flex"
              ...
              {...getOverrideProps(
                overrides,
                "molecules/button/primary/molecules/headernav/wo icon/molecules/headernav/w icon7163249"
              )}
            ></Moleculesbuttonprimarymoleculesheadernavwoiconmoleculesheadernavwicon>
          </View>
        </View>
