...
export default function Atomslogo(props) {
  const {
    overrides,
    ...rest
  } = props;
  return /*#__PURE__*/React.createElement(Flex, _extends({
  ...
  }, rest, getOverrideProps(overrides, "Atomslogo")), /*#__PURE__*/React.createElement(View, _extends({
    width: "24px",
    height: "24px",
    shrink: "0",
    overflow: "hidden",
    ...
    left: "0%",
    right: "0%"
  }, getOverrideProps(overrides, "Group54855")), /*#__PURE__*/React.createElement(Icon, _extends({
    width: "24px",
    height: "24px",
    viewBox: {
      minX: 0,
    ...
    left: "0%",
    right: "0%"
  }, getOverrideProps(overrides, "Vector54856")))), /*#__PURE__*/React.createElement(View, _extends({
    padding: "0px 0px 0px 0px",
    position: "absolute",
    top: "5.02%",
    bottom: "9.55%",
    left: "4.17%",
    right: "-4.17%"
  }, getOverrideProps(overrides, "Group54857")), /*#__PURE__*/React.createElement(Icon, _extends({
    width: "24px",
    height: "20.50323486328125px",
    viewBox: {
      minX: 0,
      minY: 0,
      width: 24,
      height: 20.50323486328125
    },
    paths: [{
    ...
    left: "0%",
    right: "0%"
  }, getOverrideProps(overrides, "Vector54858"))))), /*#__PURE__*/React.createElement(Flex, _extends({
    gap: "10px",
    direction: "row",
    width: "fit-content",
