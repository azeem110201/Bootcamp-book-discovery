...
export default function Moleculesinputfieldlabelwiconfocused(props) {
  ...
  return /*#__PURE__*/React.createElement(Flex, _extends({
  ...
  }, rest, getOverrideProps(overrides, "Moleculesinputfieldlabelwiconfocused")), /*#__PURE__*/React.createElement(Flex, _extends({
    gap: "4px",
    direction: "column",
    width: "216px",
    shrink: "0",
    ...
    whiteSpace: "pre-wrap",
    children: "Username"
  }, getOverrideProps(overrides, "Label7162861")))), /*#__PURE__*/React.createElement(View, _extends({
    width: "433px",
    height: "48px",
    shrink: "0",
    position: "relative",
  ...
  }, getOverrideProps(overrides, "Label7162863"))), /*#__PURE__*/React.createElement(Atomsiconsvisibility, _extends({
    display: "flex",
    gap: "10px",
    position: "absolute",
    top: "12px",
