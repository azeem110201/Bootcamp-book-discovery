...
export default function Atomsiconsvisibility(props) {
  ...
  return /*#__PURE__*/React.createElement(Flex, _extends({
  ...
  }, rest, getOverrideProps(overrides, "Atomsiconsvisibility")), /*#__PURE__*/React.createElement(View, _extends({
    width: "24px",
    height: "24px",
    shrink: "0",
    overflow: "hidden",
    position: "relative",
    padding: "0px 0px 0px 0px"
  }, getOverrideProps(overrides, "visibility_black_24dp 1")), /*#__PURE__*/React.createElement(Icon, _extends({
    width: "24px",
    height: "24px",
    viewBox: {
      minX: 0,
    ...
    left: "0%",
    right: "0%"
  }, getOverrideProps(overrides, "Vector291144"))), /*#__PURE__*/React.createElement(Icon, _extends({
    width: "16px",
    height: "12px",
    viewBox: {
      minX: 0,
