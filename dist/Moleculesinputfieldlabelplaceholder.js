...
export default function Moleculesinputfieldlabelplaceholder(props) {
  ...
  return /*#__PURE__*/React.createElement(Flex, _extends({
  ...
  }, rest, getOverrideProps(overrides, "Moleculesinputfieldlabelplaceholder")), /*#__PURE__*/React.createElement(Flex, _extends({
    gap: "4px",
    direction: "column",
    width: "216px",
    shrink: "0",
    ...
    whiteSpace: "pre-wrap",
    children: "Username"
  }, getOverrideProps(overrides, "Label7162851")))), /*#__PURE__*/React.createElement(Flex, _extends({
    gap: "10px",
    direction: "row",
    width: "433px",
